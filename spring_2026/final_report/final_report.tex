...
The backbone of the project is the esp-drone project from Espressif which itself is built on top of another project called crazyflie. Esp-drone provides proven flight logic, sensor fusion, state estimation, and communication protocols. It created a great basis for our project that could be further extended anyway that we needed. 
