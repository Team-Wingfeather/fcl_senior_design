...
Our PCB successfully integrates all sensor types via a single I2C bus. We have considered adding busses for individual sensors, but the current setup has worked so far.
...
\begin{enumerate}
		...
		\begin{itemize}
			...
			\item Implements both the linear and the non-linear model
		...
		\begin{itemize}
			\item Specifies the non-linear control system in the drone software
