...
The frame meets the requirements in that it keeps all parts undamaged and maintains shape in flight. The drone application can plot the given CSVs from the drone, while also allowing for the drone to be flashed from the application itself. 
